...
public class SolicitudClienteCreditoSispas extends GenericBean implements Serializable {
	 ...
	 * 
	 */
	public SolicitudClienteCreditoSispas() {
		super();
	}
	/**
	 * @param id
	 */
	public SolicitudClienteCreditoSispas(Long id) {
		super();
		this.id = id;
	}
	public Long getId() {
