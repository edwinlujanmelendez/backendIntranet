...
@XmlType(name = "", propOrder = {
    "buscarDetalleComprobanteResult"
})
@XmlRootElement(name = "buscarDetalleComprobanteResponse")
public class BuscarDetalleComprobanteResponse {

    @XmlElementRef(name = "buscarDetalleComprobanteResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<Result> buscarDetalleComprobanteResult;

    /**
     * Obtiene el valor de la propiedad buscarDetalleComprobanteResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad buscarDetalleComprobanteResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Result }{@code >}
