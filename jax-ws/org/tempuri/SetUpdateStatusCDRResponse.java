...
@XmlType(name = "", propOrder = {
    "setUpdateStatusCDRResult"
})
@XmlRootElement(name = "setUpdateStatusCDRResponse")
public class SetUpdateStatusCDRResponse {

    @XmlElementRef(name = "setUpdateStatusCDRResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<Result> setUpdateStatusCDRResult;

    /**
     * Obtiene el valor de la propiedad setUpdateStatusCDRResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad setUpdateStatusCDRResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Result }{@code >}
