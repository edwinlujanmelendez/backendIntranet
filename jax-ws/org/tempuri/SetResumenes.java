...
public class SetResumenes {
    ...
    @XmlElementRef(name = "fechaEmisionComprobantes", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    ...
    /**
     * Obtiene el valor de la propiedad fechaEmisionComprobantes.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    /**
     * Define el valor de la propiedad fechaEmisionComprobantes.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
