...
@XmlType(name = "", propOrder = {
    "getRepresentacionImpresaResult"
})
@XmlRootElement(name = "getRepresentacionImpresaResponse")
public class GetRepresentacionImpresaResponse {

    @XmlElementRef(name = "getRepresentacionImpresaResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<Result> getRepresentacionImpresaResult;

    /**
     * Obtiene el valor de la propiedad getRepresentacionImpresaResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getRepresentacionImpresaResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Result }{@code >}
